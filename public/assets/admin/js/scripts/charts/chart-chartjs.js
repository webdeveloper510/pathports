...
$(window).on('load', function () {
  ...
  var primaryColorShade = '#38c9ff',

    yellowColor = '#ffe800',

    //successColorShade = '#28dac6',
    successColorShade = '#95DBE5FF',

    warningColorShade = '#ffe802',

    //warningLightColor = '#FDAC34',
    warningLightColor = '#0095b6',
    ...
    //tooltipShadow = '#58508d',
    tooltipShadow = '#0892d0',
    RackleyColor =  '#73c2fb',
    ...
    skyblueColor = '#00A4CCFF',

    linghtBlueColor ='#87cefa',
  ...
  if (polarAreaChartEx.length) {
    ...
    var polarExample = new Chart(polarAreaChartEx, {
      ...
      data: {
        ...
        labels: ['WSU Spokane', 'WSU Vancouver','WSU Tri-Cities','WSU Everett','Washington State University','WSU World Wide'],
      ...
      data: {
        ...
        datasets: [

          {
            ...
            data: [15, 20, 50,20,60,40],

            backgroundColor: [successColorShade, warningLightColor,skyblueColor,RackleyColor,tooltipShadow,primaryColorShade],
