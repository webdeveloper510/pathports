                     ...
                     <a style="text-decoration: none;" href="#">
                        <span style="font-size: 16px;color: #ffffff; font-weight: 600;text-transform: uppercase;">
                           <marquee width="100%" direction="left">
                              <span class="latest-news">LATEST UPDATE:  </span>Best colleges for social work.
                           </marquee>
                        </span>
                     </a>
                  </span>
               ...
               <div class="eightHundred">
                  <div class="blockContents">
                     <h5 style="text-align: center;">
                        ...
                        <strong>HOW TO USE</strong></span>
                     </h5>
                     <div class="bottom-border used"></div>
                  </div>
                  <div class="row small-hor">
                     ...
                     <div class="col-md-6">
                        <div class="blockContents">
                           ...
                           <p>Students who want mentors and acceleration into a field of their choosing, by their alums, we help you land with 10x the success of everything else; If you are a mentor or university, prepare to be lifechanging.  There is no cost to you.
                           </p>
                        </div>
      ...
      <div class="container-fluid">
         <div class="small-hor">
            <h4 class="ContentArea">
               <span style="color: #175ec6;">Alumni and Councilors</span>
            </h4>
