                            ...
                            <div class="card-body">
                                <div class="user-avatar-section">
                                    <div class="d-flex align-items-center flex-column">
                                        <img class="img-fluid rounded mt-3 mb-2" src="{{ asset('/')}}assets/backend/images/portrait/small/avatar-s-2.jpg" height="110" width="110" alt="User avatar" />
...
@section('styles')
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('/')}}assets/backend/vendors/css/animate/animate.min.css">
...
@section('scripts')
    ...
    <script src="{{ asset('/')}}assets/backend/js/scripts/pages/app-user-view-account.js"></script>
    <script src="{{ asset('/')}}assets/backend/js/scripts/pages/app-user-view.js"></script>
