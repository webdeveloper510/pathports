        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">Graduates</h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index.html">Graduates</a>
                                </li>
                                <li class="breadcrumb-item"><a href="#">Lists</a>
                                </li>
                                <li class="breadcrumb-item active">Add Graduates
                                </li>
                            </ol>
                        </div>
                    </div>
        ...
        <div class="content-body">
            ...
            <form id="editUserForm" class="row gy-1 pt-75" onsubmit="return false">
                ...
                <div class="col-12 col-md-6">
                    ...
                    <input type="text" id="" class="form-control flatpickr-basic flatpickr-input" placeholder="YYYY-MM-DD" />
                    <!-- <input type="text" id="" class="form-control flatpickr-basic schedule-date flatpickr-input active" placeholder="YYYY-MM-DD" readonly="readonly"> -->
                ...
                <div class="col-12 col-md-6">
                    ...
                    <select class="form-select" id="basicSelect">
                        ...
                        <option>Middle Eastern/Arabic</option>
                ...
                <div class="col-12 col-md-6">
                    <label class="form-label" for="basicSelect">Green Card (Required)</label>
