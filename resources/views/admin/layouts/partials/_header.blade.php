...
<?php $id =base64_encode(auth()->user()->id); ?> 
...
<!-- <a href="{{route('email-send')}}"> -->
    ...
    <!-- <button type="submit" class="btn btn-primary" id="survey_submit" onclick='getMessage()' style="padding: 8px 14px;
    margin-right: 15px; margin-top: 5px;">Send Survey Email</button> -->
<!-- </a> -->
   <!-- <li class="nav-item dropdown dropdown-language"><a class="nav-link dropdown-toggle" id="dropdown-flag" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="flag-icon flag-icon-us"></i><span class="selected-language">English</span></a>
                ...
                <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <div class="user-nav d-sm-flex d-none"><span class="user-name fw-bolder">{{@Auth::user()->firstName}} {{@Auth::user()->lastName}}</span><span class="user-status">  
                    ...
                    <!-- </span></div><span class="avatar"><img class="round" src="{{ asset('/')}}assets/admin/images/portrait/small/avatar-s-11.jpg" alt="avatar" height="40" width="40"><span class="avatar-status-online"></span></span> -->
                    
                        @if(Auth::user()->image)
                            @if ( auth()->user()->role_id == 1 || auth()->user()->role_id == 2)
                                </span></div><span class="avatar"><img class="round" src="{{ asset('/')}}assets/admin/images/profile/{{Auth::user()->image}}" alt="avatar"  style="height: 40px; width: 40px;"><span class="avatar-status-online"></span></span>
                            @endif
                            @if ( auth()->user()->role_id == 3)
                                </span></div><span class="avatar"><img class="round" src="{{ asset('/')}}assets/admin/images/student_profile/{{Auth::user()->image}}" alt="avatar"  style="height: 40px; width: 40px;"><span class="avatar-status-online"></span></span>
                            @endif
                            @if ( auth()->user()->role_id == 4)
                                </span></div><span class="avatar"><img class="round" src="{{ asset('/')}}assets/admin/images/alumini/profile/{{Auth::user()->image}}" alt="avatar"  style="height: 40px; width: 40px;"><span class="avatar-status-online"></span></span>
                            @endif
                        
                        @else
                            </span></div><span class="avatar"><img class="round" src="{{ asset('/')}}assets/admin/images/profile/default-image.jpg" alt="avatar"  style="height: 40px; width: 40px;"><span class="avatar-status-online"></span></span>
                        @endif
                    ...
                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-user">
                        <a class="dropdown-item" href="{{route('change-password',$id)}}"><i class="fa fa-key" aria-hidden="true"></i> Change Password</a> 

                        <a class="dropdown-item" href="{{route('profile',[Auth::user()->id])}}"><i class="me-50" data-feather="user"></i> Profile</a>
