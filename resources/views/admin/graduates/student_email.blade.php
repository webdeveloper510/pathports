    ...
    <section class="email-template">
        <div class="container" style="max-width: 1200px; margin: 0 auto; padding: 0 20px;">
            ...
            <!-- <div class="email-template-container" style="max-width: 550px; margin: 0 auto; background-color: #fff; box-shadow: 0 0 10px rgba(0, 0, 0, .2); padding: 24px; border-radius: 3px;"> -->
                ...
                <p style="margin-bottom: 15px; color: #484848;">You have Registered Successfully</p>
                <div class="email-content">
                    <div style="font-weight: bold; margin: 5px 0;" class="content">Email: <span style="font-weight: normal;">{{ $email }}</span></div>
                    <div style="font-weight: bold; margin: 5px 0;" class="content">Password: <span style="font-weight: normal;">{{ $password }}</span></div>
                    </div>
