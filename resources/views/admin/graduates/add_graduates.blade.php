...
<!-- BEGIN: Content-->
    ...
    <div class="content-wrapper container-xxl p-0">
        ...
        <div class="content-body">
            ...
            <form id="editUserForm" class="row gy-1 pt-75" method="POST" action="{{route('student.store')}}" enctype="multipart/form-data">
            ...
            @csrf
                ...
                <div class="col-12 col-md-6">
                    ...
                    <input type="text" class="form-control" id="basicInput" name="username" value="{{old('username')}}" placeholder="Please Enter Your Username" />
  @error('username')<div class="invalid-feedback"> {{ $message }} </div>@enderror
                ...
                <div class="col-12 col-md-6">
                    ...
                    <input type="email" id="modalEditUserEmail" name="alternat_email" class="form-control @error('lastname') is-invalid @enderror" value="{{old('alternat_email')}}" placeholder="Please Enter Your Email" />
                </div>

                <div class="col-12 col-md-6">

                    <label class="form-label" for="modalEditUserPhone">Contact</label>
                    <input type="text" id="modalEditUserPhone" name="contact" class="form-control phone-number-mask @error('contact') is-invalid @enderror" minlength="12" placeholder="Please Enter Your Contact Number" value="{{old('contact')}}" />
                ...
                <div class="col-12 col-md-6">
                    ...
                    <input type="password" name="password" class="form-control @error('password') is-invalid @enderror " id="basicInput" placeholder="Please Enter Your Password" value="{{old('password')}}"/>
                ...
                <div class="col-12 col-md-6">
                    ...
                    <input type="text" id="" class="form-control flatpickr-basic flatpickr-input @error('year_of_joining') is-invalid @enderror" value="{{old('year_of_joining')}}" name="year_of_joining" placeholder="Please Enter Your Joining Date" />
                ...
                <div class="col-12 col-md-6">
                    ...
                    <input class="form-control" type="file" id="customFile2"  name="graduate_resume"/>
                </div>
                <div class="col-12 text-center mt-2 pt-50">
                    <button type="submit" class="btn btn-primary me-1 add-button">Add</button>
                    <button type="reset" class="btn btn-outline-secondary" data-bs-dismiss="modal" aria-label="Close">
                        <a href="{{route('student.index')}}">Discard</a>
                    </button>
                </div>
            </form>
        </div>
